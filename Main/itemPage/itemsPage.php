...
<html>
    <head>
        <meta charset="UTF-8">
        <meta name="description" content="Hotspot information">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">

        <title>Hotspot Info</title>
        ...
        <div id="wrapper">
            <div id="left_wrapper">
                <div id="mapIndividual">
                    <!--the map containing the location of the hotspot -->
                </div>
                    ...
                    <div id="details">
                        ...
                        if (isset($_GET['id'])) {
                            ...
                            foreach ($result as $item) {
                                ...
                                //write the name of the hotspot
                                echo '<p>Name: ' . $item['Name'] . '</p>';
                                //write the suburb of the hotspot
                                echo '<p>Suburb:  ' . $item['Suburb'] . '</p>';

                                //include the function to find the average rating of the hotspotID
                                include_once "averageRatingQuery.php";
                                //write the average star rating of the hotspot if it exists, if not write "Not Rated"
            ...
            <div id="right_wrapper">
                ...
                <div id="reviews">
                    ...
                    //check if there is a review written for the hotspot
                    if ($result->rowCount() > 0) {

                        //loop through the reviews written for the hotspot in the database and record the name of the poster,
