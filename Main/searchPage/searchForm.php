<form id="searchForm" class="registration_and_login" action="../resultsPage/results.php" method="get">
    ...
    input_checkbox($errors, 'locationSearch', 'Search for hotspots near you: ', 'getLocation()');
