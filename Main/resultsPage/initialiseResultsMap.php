<?php
    ...
    echo '<script>';
        ...
        echo 'function initMap() {';
            ...
            //include the search hotspots query to find all info about items matching the search
            include 'searchHotspotsQuery.php';
            ...
            foreach ($stmt as $marker) {
                ...
                //contains the suburb, address, coordinates and a link the item's page
                ...
                //create the marker for the hotspot
